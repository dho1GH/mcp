/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a4ae299ebd7760541c60ebc43cffc4a)
// Runtime types generated with workerd@1.20260801.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	ApprovalCoordinator: DurableObjectNamespace<import("./src/worker").ApprovalCoordinator>;
	APPROVAL_WORKFLOW: Workflow<Parameters<import("./src/worker").ApprovalExecutionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ApprovalCoordinator";
	}
